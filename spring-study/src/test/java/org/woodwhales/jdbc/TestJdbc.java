...
import org.woodwhales.jdbc.dao.DepartmentDao;
import org.woodwhales.jdbc.dao.EmployeeDao;
...
public class TestJdbc {
	...
	public void testNamedParameterJdbcTemplate(){
		...
		int updateResult = namedParameterJdbcTemplate.update(sql, paramMap);
		System.out.println((1 == updateResult) ? "update success" : "update failed");
	}
